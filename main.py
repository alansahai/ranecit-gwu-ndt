"""
main.py — AcoustiScan Pro v2.0
Acoustic NDT Simulation Dashboard with:
  • User-defined material property model
  • Gantry animation with live sensor array
  • Signal graph that grows with gantry movement
...
st.set_page_config(page_title="AcoustiScan Pro v2", page_icon="🔊",
...
.badge-v2{display:inline-block;background:#00d4ff18;color:#00d4ff;border:1px solid #00d4ff44;border-radius:4px;padding:1px 8px;font-family:monospace;font-size:.74rem;margin-left:10px;vertical-align:middle}
...
st.markdown("""<div class="ndt-header">
  <h1>🔊 ACOUSTISCAN PRO <span class="badge-v2">v2.0</span></h1>
...
with st.sidebar:
    ...
    anim_step      = st.slider("Animation Density (1=all)", 1, 8, 4,
...
# ═══════════════════════════════════════════════════════
st.markdown('<p class="sh">🔬 ALUMINIUM DIE CAST — MATERIAL PROPERTIES</p>', unsafe_allow_html=True)
...
ACOUSTISCAN PRO v2.0 · Physics Material Model · Gantry Animation · Live Acquisition
